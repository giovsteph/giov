                ...
                <div className="container">
                  <div className="intro">
                    ...
                    <div className="bio">
                      ...
                      <p>
                        Currently, my favorite front end framework is Angular,
                        but I also like to use React.
                      </p>
                      <p>
                    ...
                    <div className="about-info">
                      <div className="about-left">
                        <p className="about-bio">
                          ...
                          engineer currently working at Wizeline, where I thrive
                          on tackling diverse projects for multiple clients.
                          Before joining Wizeline, I honed my skills as a
                          front-end developer in a dynamic startup environment.
                          My journey in the tech world began in 2019 when I
                          embarked on an exciting adventure with the{" "}
                          <a
                          ...
                          expertise in Angular, React, and associated
                          technologies to craft remarkable digital solutions.
                          Let's embark on a journey together, where we can bring
                          your ideas to life in the most innovative and
                          impactful ways!
                        </p>
                        <p>
                ...
                <div className="container" id="work">
                  <div className="work">
                    <div className="work-title">
                      <span className="numbers">03. </span> Some things I've
                      built
                    </div>
                    <div>
                      {projects.map((proj) => (
